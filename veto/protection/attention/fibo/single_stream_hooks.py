...
from veto.protection.attention.fibo.single_stream_processor import (
    VetoFiboSingleStreamAttentionProcessor,
)
...
def install_single_stream_processors(
    ...
    *,
    ...
    def factory(idx: int) -> VetoFiboSingleStreamAttentionProcessor:
        return VetoFiboSingleStreamAttentionProcessor(
