...
from veto.protection.attention.fibo.double_stream_processor import (
    VetoFiboDoubleStreamAttentionProcessor,
)
...
def install_double_stream_processors(
    ...
    *,
    ...
    def factory(idx: int) -> VetoFiboDoubleStreamAttentionProcessor:
        return VetoFiboDoubleStreamAttentionProcessor(
